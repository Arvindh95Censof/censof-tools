...
```
uvx --from grp-mcp-plugin==0.81.0rc24 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc24 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc24` names an exact version on purpose.
