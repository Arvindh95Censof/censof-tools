...
```
uvx --from grp-mcp-plugin==0.81.0rc19 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc19 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc19` names an exact version on purpose.
