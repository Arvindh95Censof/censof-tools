...
```
uvx --from grp-mcp-plugin==0.81.0rc37 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc37 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc37` names an exact version on purpose.
