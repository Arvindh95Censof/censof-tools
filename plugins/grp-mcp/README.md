...
```
uvx --from grp-mcp-plugin==0.81.0rc30 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc30 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc30` names an exact version on purpose.
