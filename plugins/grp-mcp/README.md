...
```
uvx --from grp-mcp-plugin==0.81.0rc20 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc20 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc20` names an exact version on purpose.
