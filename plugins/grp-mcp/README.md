...
```
uvx --from grp-mcp-plugin==0.81.0rc22 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc22 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc22` names an exact version on purpose.
