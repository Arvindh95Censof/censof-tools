...
```
uvx --from grp-mcp-plugin==0.81.0rc18 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc18 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc18` names an exact version on purpose.
