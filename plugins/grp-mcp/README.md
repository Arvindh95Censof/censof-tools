...
```
uvx --from grp-mcp-plugin==0.81.0rc23 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc23 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc23` names an exact version on purpose.
