...
```
uvx --from grp-mcp-plugin==0.81.0rc21 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc21 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc21` names an exact version on purpose.
