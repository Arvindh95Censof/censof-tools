...
```
uvx --from grp-mcp-plugin==0.81.0rc33 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc33 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc33` names an exact version on purpose.
