...
```
uvx --from grp-mcp-plugin==0.81.0rc31 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc31 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc31` names an exact version on purpose.
