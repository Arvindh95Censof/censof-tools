...
```
uvx --from grp-mcp-plugin==0.81.0rc38 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc38 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc38` names an exact version on purpose.
