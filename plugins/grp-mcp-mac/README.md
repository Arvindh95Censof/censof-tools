...
```
uvx --from grp-mcp-plugin==0.81.0rc35 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc35 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc35` names an exact version on purpose.
