...
```
uvx --from grp-mcp-plugin==0.81.0rc32 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc32 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc32` names an exact version on purpose.
