...
```
uvx --from grp-mcp-plugin==0.81.0rc36 grp-mcp
```
...
```
uvx --from grp-mcp-plugin==0.81.0rc36 grp-mcp-setup
```
...
`--from grp-mcp-plugin==0.81.0rc36` names an exact version on purpose.
